...
{
    meta:
        description = "PE has no kernel32/ntdll/api-ms imports yet is larger than 20 KB -- executable with zero standard imports almost certainly resolves APIs dynamically"
        severity = "malicious"
    strings:
        $mz       = { 4D 5A }
